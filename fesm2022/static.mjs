...
import { m as module_, U as UPGRADE_APP_TYPE_KEY, I as INJECTOR_KEY, g as UPGRADE_MODULE_NAME, L as LAZY_MODULE_REF, a as $INJECTOR, h as $PROVIDE, D as DOWNGRADED_MODULE_COUNT_KEY, $ as $SCOPE, d as $$TESTABILITY, i as $DELEGATE, j as $INTERVAL, e as element, b as bootstrap } from './constants-BN4MeWvk.mjs';
export { k as getAngularJSGlobal, l as getAngularLib, s as setAngularJSGlobal, n as setAngularLib, o as ɵangular1, p as ɵconstants } from './constants-BN4MeWvk.mjs';
import { b as destroyApp, g as getDowngradedModuleCount, e as isNgModuleType, i as isFunction, U as UpgradeHelper, c as controllerKey } from './upgrade_helper-BopwrkGG.mjs';
export { V as VERSION, d as downgradeComponent, a as downgradeInjectable, u as ɵupgradeHelper, f as ɵutil } from './upgrade_helper-BopwrkGG.mjs';
...
class UpgradeComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0-next.4+sha-bdfbd54", ngImport: i0, type: UpgradeComponent, deps: "invalid", target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.0.0-next.4+sha-bdfbd54", type: UpgradeComponent, isStandalone: true, usesOnChanges: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0-next.4+sha-bdfbd54", ngImport: i0, type: UpgradeComponent, decorators: [{
            type: Directive
...
class UpgradeModule {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0-next.4+sha-bdfbd54", ngImport: i0, type: UpgradeModule, deps: [{ token: i0.Injector }, { token: i0.NgZone }, { token: i0.PlatformRef }], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.0.0-next.4+sha-bdfbd54", ngImport: i0, type: UpgradeModule });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.0.0-next.4+sha-bdfbd54", ngImport: i0, type: UpgradeModule, providers: [angular1Providers] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0-next.4+sha-bdfbd54", ngImport: i0, type: UpgradeModule, decorators: [{
            type: NgModule,
