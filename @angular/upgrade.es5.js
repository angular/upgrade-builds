...
import { DirectiveResolver, createElementCssSelector, CssSelector, SelectorMatcher } from '@angular/compiler';
...
var /** @type {?} */_bootstrap = angular.bootstrap;
...
var ContentProjectionHelper = function () {
    function ContentProjectionHelper() {
        _classCallCheck(this, ContentProjectionHelper);
    }

    _createClass(ContentProjectionHelper, [{
        key: 'groupProjectableNodes',
         ...
         * @return {?}
         */
        value: function groupProjectableNodes($injector, component, nodes) {
...
var DowngradeComponentAdapter = function () {
    ...
    function DowngradeComponentAdapter(id, info, element, attrs, scope, ngModel, parentInjector, $injector, $compile, $parse, componentFactory) {
        _classCallCheck(this, DowngradeComponentAdapter);
    ...
    _createClass(DowngradeComponentAdapter, [{
        key: 'compileContents',
        value: function compileContents() {
            var _this2 = this;
            ...
            var /** @type {?} */linkFns = projectableNodes.map(function (nodes) {
                return _this2.$compile(nodes);
            });
            this.element.empty();
            linkFns.forEach(function (linkFn) {
                linkFn(_this2.scope, function (clone) {
        ...
        key: 'createComponent',
        value: function createComponent(projectableNodes) {
        ...
        value: function setupInputs() {
                ...
                if (attrs.hasOwnProperty(input.attr)) {
                    var /** @type {?} */observeFn = function (prop) {
                        ...
                        return function (currValue) {
                            ...
                            _this3.updateInput(prop, prevValue, currValue);
                            prevValue = currValue;
                        };
                    }(input.prop);
                ...
                if (expr != null) {
                    var /** @type {?} */watchFn = function (prop) {
                        return function (currValue, prevValue) {
                            return _this3.updateInput(prop, prevValue, currValue);
                        };
                    }(input.prop);
            ...
            if (prototype && prototype.ngOnChanges) {
                ...
                this.componentScope.$watch(function () {
                    return _this3.inputChangeCount;
                }, function () {
                    var /** @type {?} */inputChanges = _this3.inputChanges;
                    _this3.inputChanges = {};
                    _this3.component.ngOnChanges(inputChanges);
                });
            }
            this.componentScope.$watch(function () {
                return _this3.changeDetector && _this3.changeDetector.detectChanges();
            });
        }
        /**
         * @return {?}
        ...
        value: function setupOutputs() {
            ...
            for (var /** @type {?} */j = 0; j < outputs.length; j++) {
                ...
                var /** @type {?} */bracketParenAttr = output.bracketParenAttr ? '[(' + output.bracketParenAttr.substring(2, output.bracketParenAttr.length - 8) + ')]' : null;
                        ...
                        emitter.subscribe({
                            next: assignExpr ? function (setter) {
                                return function (v /** TODO #9100 */) {
                                    return setter(_this4.scope, v);
                                };
                            }(setter) : function (getter) {
                                return function (v /** TODO #9100 */) {
                                    return getter(_this4.scope, { $event: v });
                                };
                            }(getter)
                        });
                    } else {
        ...
        key: 'registerCleanup',
        value: function registerCleanup() {
            var _this5 = this;

            this.element.bind('$destroy', function () {
                _this5.componentScope.$destroy();
                _this5.componentRef.destroy();
            });
        }
        /**
         * @return {?}
        ...
        key: 'updateInput',
        value: function updateInput(prop, prevValue, currValue) {
...
function downgradeComponent(info) {
    ...
    var /** @type {?} */idCount = 0;
    var /** @type {?} */directiveFactory = function directiveFactory($compile, $injector, $parse) {
        return {
            restrict: 'E',
            terminal: true,
            ...
            link: function link(scope, element, attrs, required) {
                ...
                var /** @type {?} */downgradeFn = function downgradeFn(injector) {
...
var ParentInjectorPromise$1 = function () {
    ...
    function ParentInjectorPromise$1(element) {
        _classCallCheck(this, ParentInjectorPromise$1);
    ...
    _createClass(ParentInjectorPromise$1, [{
        key: 'then',
        ...
        key: 'resolve',
        value: function resolve(injector) {
            this.injector = injector;
...
function downgradeInjectable(token) {
    var /** @type {?} */factory = function factory(i) {
        return i.get(token);
    };
...
var DynamicContentProjectionHelper = function (_ContentProjectionHel) {
    _inherits(DynamicContentProjectionHelper, _ContentProjectionHel);

    function DynamicContentProjectionHelper() {
        _classCallCheck(this, DynamicContentProjectionHelper);

        return _possibleConstructorReturn(this, (DynamicContentProjectionHelper.__proto__ || Object.getPrototypeOf(DynamicContentProjectionHelper)).apply(this, arguments));
    }

    _createClass(DynamicContentProjectionHelper, [{
        key: 'groupProjectableNodes',
        ...
        key: 'groupNodesBySelector',
        value: function groupNodesBySelector(ngContentSelectors, nodes) {
            var /** @type {?} */projectableNodes = [];
            var /** @type {?} */matcher = new SelectorMatcher();
            var /** @type {?} */wildcardNgContentIndex = void 0;
...
var UpgradeNg1ComponentAdapterBuilder = function () {
    ...
    function UpgradeNg1ComponentAdapterBuilder(name) {
        _classCallCheck(this, UpgradeNg1ComponentAdapterBuilder);
        ...
        var selector = name.replace(CAMEL_CASE, function (all /** TODO #9100 */, next) {
            return '-' + next.toLowerCase();
        });
        var self = this;
        this.type = Directive({ selector: selector, inputs: this.inputsRename, outputs: this.outputsRename }).Class({
            constructor: [new Inject($SCOPE), ElementRef, function (scope, elementRef) {
    ...
    _createClass(UpgradeNg1ComponentAdapterBuilder, [{
        ...
        value: function extractDirective(injector) {
        ...
        key: 'notSupported',
        value: function notSupported(feature) {
        ...
        key: 'extractBindings',
        value: function extractBindings() {
            var /** @type {?} */btcIsObject = _typeof(this.directive.bindToController) === 'object';
        ...
        key: 'compileTemplate',
        value: function compileTemplate(compile, templateCache, httpBackend) {
            var _this7 = this;

            if (this.directive.template !== undefined) {
                this.linkFn = compileHtml(isFunction(this.directive.template) ? this.directive.template() : this.directive.template);
            } else if (this.directive.templateUrl) {
                var /** @type {?} */url = isFunction(this.directive.templateUrl) ? this.directive.templateUrl() : this.directive.templateUrl;
                var /** @type {?} */html = templateCache.get(url);
                if (html !== undefined) {
                    ...
                    return new Promise(function (resolve, err) {
                        httpBackend('GET', url, null, function (status /** TODO #9100 */, response /** TODO #9100 */) {
                            if (status == 200) {
                                resolve(_this7.linkFn = compileHtml(templateCache.put(url, response)));
                            } else {
        ...
        key: 'resolve',
        value: function resolve(exportedComponents, injector) {
            var /** @type {?} */promises = [];
...
var UpgradeNg1ComponentAdapter = function () {
    ...
    function UpgradeNg1ComponentAdapter(linkFn, scope, directive, elementRef, $controller, inputs, outputs, propOuts, checkProperties, propertyMap) {
        _classCallCheck(this, UpgradeNg1ComponentAdapter);
        ...
        for (var j = 0; j < outputs.length; j++) {
            ...
            this.setComponentProperty(outputs[j], function (emitter /** TODO #9100 */) {
    ...
    _createClass(UpgradeNg1ComponentAdapter, [{
        ...
        value: function ngOnInit() {
            ...
            if ((typeof link === 'undefined' ? 'undefined' : _typeof(link)) == 'object') link = link.pre;
            if (link) {
            ...
            var /** @type {?} */childNodes = [];
            var /** @type {?} */childNode = void 0 /** TODO #9100 */;
            ...
            this.linkFn(this.componentScope, function (clonedElement, scope) {
                for (var /** @type {?} */i = 0, /** @type {?} */ii = clonedElement.length; i < ii; i++) {
                    _this8.element.appendChild(clonedElement[i]);
                }
            }, {
                parentBoundTranscludeFn: function parentBoundTranscludeFn(scope /** TODO #9100 */, cloneAttach /** TODO #9100 */) {
        ...
        value: function ngOnChanges(changes) {
            ...
            Object.keys(changes).forEach(function (name) {
                ...
                _this9.setComponentProperty(name, change.currentValue);
                ng1Changes[_this9.propertyMap[name]] = change;
            });
        ...
        key: 'setComponentProperty',
        value: function setComponentProperty(name, value) {
        ...
        key: 'buildController',
        value: function buildController(controllerType /** TODO #9100 */) {
        ...
        key: 'resolveRequired',
        value: function resolveRequired($element, require) {
            if (!require) {
                return undefined;
...
var UpgradeAdapter = function () {
    ...
    function UpgradeAdapter(ng2AppModule, compilerOptions) {
        _classCallCheck(this, UpgradeAdapter);
    ...
    _createClass(UpgradeAdapter, [{
        key: 'downgradeNg2Component',
        value: function downgradeNg2Component(component) {
        ...
        key: 'upgradeNg1Component',
        value: function upgradeNg1Component(name) {
            if (this.ng1ComponentsToBeUpgraded.hasOwnProperty(name)) {
                return this.ng1ComponentsToBeUpgraded[name].type;
            } else {
                return (this.ng1ComponentsToBeUpgraded[name] = new UpgradeNg1ComponentAdapterBuilder(name)).type;
            }
        }
        /**
        ...
        key: 'registerForNg1Tests',
        value: function registerForNg1Tests(modules) {
            var _this10 = this;
            ...
            this.ng2BootstrapDeferred.promise.then(function (ng1Injector) {
                upgrade._bootstrapDone(_this10.moduleRef, ng1Injector);
            }, onError);
            return upgrade;
        }
        /**
        ...
        key: 'bootstrap',
        value: function bootstrap(element$$, modules, config) {
            var _this11 = this;
            ...
            this.ngZone.run(function () {
                _bootstrap(element$$, [_this11.ng1Module.name], config);
            });
            ...
            Promise.all([this.ng2BootstrapDeferred.promise, ng1BootstrapPromise]).then(function (_ref) {
                var _ref2 = _slicedToArray(_ref, 1),
                    ng1Injector = _ref2[0];

                element(element$$).data(controllerKey(INJECTOR_KEY), _this11.moduleRef.injector);
                _this11.moduleRef.injector.get(NgZone).run(function () {
                    upgrade._bootstrapDone(_this11.moduleRef, ng1Injector);
                });
            }, onError);
            return upgrade;
        }
        ...
        key: 'upgradeNg1Provider',
        value: function upgradeNg1Provider(name, options) {
        ...
        key: 'downgradeNg2Provider',
        value: function downgradeNg2Provider(token) {
        ...
        value: function declareNg1Module() {
            var _this12 = this;

            var modules = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

            var /** @type {?} */delayApplyExps = [];
            var /** @type {?} */original$applyFn = void 0;
            var /** @type {?} */rootScopePrototype = void 0;
            var /** @type {?} */rootScope = void 0;
            ...
            ng1Module.factory(INJECTOR_KEY, function () {
                return _this12.moduleRef.injector.get(Injector);
            }).constant(NG_ZONE_KEY, this.ngZone).factory(COMPILER_KEY, function () {
                return _this12.moduleRef.injector.get(Compiler);
            }).config(['$provide', '$injector', function (provide, ng1Injector) {
                provide.decorator($ROOT_SCOPE, ['$delegate', function (rootScopeDelegate) {
                ...
                if (ng1Injector.has($$TESTABILITY)) {
                    provide.decorator($$TESTABILITY, ['$delegate', function (testabilityDelegate) {
                        ...
                        var /** @type {?} */newWhenStable = function newWhenStable(callback) {
            ...
            ng1Module.run(['$injector', '$rootScope', function (ng1Injector, rootScope) {
                UpgradeNg1ComponentAdapterBuilder.resolve(_this12.ng1ComponentsToBeUpgraded, ng1Injector).then(function () {
                    ...
                    var /** @type {?} */DynamicNgUpgradeModule = NgModule({
                        providers: [{ provide: $INJECTOR, useFactory: function useFactory() {
                                return ng1Injector;
                            } }, { provide: $COMPILE, useFactory: function useFactory() {
                                return ng1Injector.get($COMPILE);
                            } }, { provide: ContentProjectionHelper, useClass: DynamicContentProjectionHelper }, _this12.upgradedProviders],
                        imports: [_this12.ng2AppModule],
                        entryComponents: _this12.downgradedComponents
                    }).Class({
                        constructor: function DynamicNgUpgradeModule() {},
                        ngDoBootstrap: function ngDoBootstrap() {}
                    });
                    platformRef._bootstrapModuleWithZone(DynamicNgUpgradeModule, _this12.compilerOptions, _this12.ngZone).then(function (ref) {
                        _this12.moduleRef = ref;
                        ...
                        return _this12.ng2BootstrapDeferred.resolve(ng1Injector);
                    }, onError).then(function () {
                        var /** @type {?} */subscription = _this12.ngZone.onMicrotaskEmpty.subscribe({ next: function next() {
                    ...
                    return _this12.ng2BootstrapDeferred.reject(e);
                });
            }]);
            return ng1Module;
        }
...
var UpgradeAdapterRef = function () {
    function UpgradeAdapterRef() {
        _classCallCheck(this, UpgradeAdapterRef);
    ...
    _createClass(UpgradeAdapterRef, [{
        key: '_bootstrapDone',
        value: function _bootstrapDone(ngModuleRef, ng1Injector) {
