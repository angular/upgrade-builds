...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function N(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];return j(t)?t.apply(void 0,c(e)):t}function _(t){return t&&!Array.isArray(t)&&"object"==typeof t}function B(t,e){throw new Error("Upgraded directive '"+t+"' contains unsupported feature: '"+e+"'.")}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
return function e(t,n){void 0===n&&(n="");var r=function(e){var r=""+d+n,o=j(t)?w(t):String(t);return C(e,n,r,"instantiating injectable '"+o+"'"),e.get(r).get(t)};return r.$inject=["$injector"],r}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(t)},t.prototype.declareNg1Module=function(t){var r=this;void 0===t&&(t=[]);var o,i,a=[],c=this,u=this.ng1Module=l.module(this.idPrefix,t),p=n.platformBrowserDynamic();return this.ngZone=new e.NgZone({enableLongStackTrace:Zone.hasOwnProperty("longStackTraceZoneSpec")}),this.ng2BootstrapDeferred=new O,u.constant("$$angularUpgradeAppType",1).factory(d,(function(){return r.moduleRef.injector.get(e.Injector)})).factory("$$angularLazyModuleRef",[d,function(t){return{injector:t}}]).constant("$$angularNgZone",this.ngZone).factory("$$angularCompiler",(function(){return r.moduleRef.injector.get(e.Compiler)})).config(["$provide","$injector",function(t,n){t.decorator("$rootScope",["$delegate",function(t){if(!(i=t.constructor.prototype).hasOwnProperty("$apply"))throw new Error("Failed to find '$apply' on '$rootScope'!");return o=i.$apply,i.$apply=function(t){return a.push(t)},t}]),n.has("$$testability")&&t.decorator("$$testability",["$delegate",function(t){var n=t.whenStable,r=function(t){n.call(this,(function(){var n=c.moduleRef.injector.get(e.Testability);n.isStable()?t.apply(this,arguments):n.whenStable(r.bind(this,t))}))};return t.whenStable=r,t}])}]),u.run(["$injector","$rootScope",function(t,n){x.resolve(r.ng1ComponentsToBeUpgraded,t).then((function(){var c={providers:[{provide:"$injector",useFactory:function(){return t}},{provide:"$compile",useFactory:function(){return t.get("$compile")}},r.upgradedProviders],imports:[e.resolveForwardRef(r.ng2AppModule)],entryComponents:r.downgradedComponents},u=function(){function t(){}return t.prototype.ngDoBootstrap=function(){},t.decorators=[{type:e.NgModule,args:[s({jit:!0},c)]}],t.ctorParameters=function(){return[]},t}();p.bootstrapModule(u,[r.compilerOptions,{ngZone:r.ngZone}]).then((function(t){r.moduleRef=t,r.ngZone.run((function(){if(i){for(i.$apply=o;a.length;)n.$apply(a.shift());i=null}}))})).then((function(){return r.ng2BootstrapDeferred.resolve(t)}),y).then((function(){var t=r.ngZone.onMicrotaskEmpty.subscribe({next:function(){return n.$$phase?(e.isDevMode()&&console.warn("A digest was triggered while one was already in progress. This may mean that something is triggering digests outside the Angular zone."),n.$evalAsync((function(){}))):n.$digest()}});n.$on("$destroy",(function(){t.unsubscribe()}))}))})).catch((function(t){return r.ng2BootstrapDeferred.reject(t)}))}]),u},t}(),V=(function(){function t(t){this.element=t,this.callbacks=[],t.data(v(d),this)}t.prototype.then=function(t){this.injector?t(this.injector):this.callbacks.push(t)},t.prototype.resolve=function(t){this.injector=t,this.element.data(v(d),t),this.element=null,this.callbacks.forEach((function(e){return e(t)})),this.callbacks.length=0}}(),function(){function t(){this._readyFn=null,this.ng1RootScope=null,this.ng1Injector=null,this.ng2ModuleRef=null,this.ng2Injector=null}return t.prototype._bootstrapDone=function(t,e){this.ng2ModuleRef=t,this.ng2Injector=t.injector,this.ng1Injector=e,this.ng1RootScope=e.get("$rootScope"),this._readyFn&&this._readyFn(this)},t.prototype.ready=function(t){this._readyFn=t},t.prototype.dispose=function(){this.ng1Injector.get("$rootScope").$destroy(),this.ng2ModuleRef.destroy()},t}());
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
