 ...
 */
function noNg(){throw new Error("AngularJS v1.x is not loaded!")}function setAngularLib(ng){angular=ng}function bootstrap(e,modules,config){angular.bootstrap(e,modules,config)}function module$1(prefix,dependencies){return angular.module(prefix,dependencies)}function element(e){return angular.element(e)}/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var angular,VERSION=new _angular_core.Version("4.1.0-beta.1-8ad464d");try{window.hasOwnProperty("angular")&&setAngularLib(window.angular)}catch(e){setAngularLib({bootstrap:noNg,module:noNg,element:noNg,version:noNg,resumeBootstrap:noNg,getTestability:noNg})}/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
