...
(function (global, factory) {
    ...
    var DowngradeComponentAdapter = /** @class */ (function () {
        ...
        DowngradeComponentAdapter.prototype.registerCleanup = function () {
            ...
            this.componentScope.$on('$destroy', function () {
                if (!destroyed) {
                    destroyed = true;
                    _this.componentRef.injector.get(i0.TestabilityRegistry)
            ...
            return {
                ...
                link: function (scope, element, attrs, required) {
                    ...
                    var downgradeFn = !needsNgZone ? doDowngrade : function (injector) {
                        if (!ngZone) {
                            ngZone = injector.get(i0.NgZone);
                            wrapCallback = function (cb) { return function () {
                                return i0.NgZone.isInAngularZone() ? cb() : ngZone.run(cb);
                            }; };
                        }
    ...
    var UpgradeComponent = /** @class */ (function () {
        ...
        UpgradeComponent.prototype.ngDoCheck = function () {
            ...
            twoWayBoundProperties.forEach(function (propName, idx) {
                ...
                if (!i0.ɵlooseIdentical(newValue, oldValue)) {
    ...
    ***************************************************************************** */
    ...
    var UpgradeModule = /** @class */ (function () {
        ...
        UpgradeModule.ngInjectorDef = i0.defineInjector({ factory: function UpgradeModule_Factory() { return new UpgradeModule(i0.inject(i0.INJECTOR), i0.inject(i0.NgZone)); }, providers: [angular1Providers], imports: [] });
