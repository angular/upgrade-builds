...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var D=function(){function t(){this.resolved=!1,this.callbacks=[]}return t.all=function(e){var n=new t,r=0,o=[],i=function(t,i){o[t]=i,++r===e.length&&n.resolve(o)};return e.forEach((function(t,e){!function n(t){return!!t&&b(t.then)}(t)?i(e,t):t.then((function(t){return i(e,t)}))})),n},t.prototype.resolve=function(t){this.resolved||(this.value=t,this.resolved=!0,this.callbacks.forEach((function(e){return e(t)})),this.callbacks.length=0)},t.prototype.then=function(t){this.resolved?t(this.value):this.callbacks.push(t)},t}(),S=function(t){function e(e){var n=t.call(this)||this;return n.element=e,n.injectorKey=v(f),e.data(n.injectorKey,n),n}return function n(t,e){function n(){this.constructor=t}p(t,e),t.prototype=null===e?Object.create(e):(n.prototype=e.prototype,new n)}(e,t),e.prototype.resolve=function(e){this.element.data(this.injectorKey,e),this.element=null,t.prototype.resolve.call(this,e)},e}(D),k=new e.Version("11.1.0-next.1+103.sha-85760cb"),I=null;function M(t){I=t}var R=[{provide:"$injector",useFactory:function P(){if(!I)throw new Error("Trying to get the AngularJS injector before it being set.");var t=I;return I=null,t},deps:[]},{provide:"$rootScope",useFactory:function N(t){return t.get("$rootScope")},deps:["$injector"]},{provide:"$compile",useFactory:function _(t){return t.get("$compile")},deps:["$injector"]},{provide:"$parse",useFactory:function B(t){return t.get("$parse")},deps:["$injector"]}],U=function(){function t(t){this.modInjector=t}return t.prototype.get=function(t,n){return n===e.ɵNOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR?n:this.modInjector.get(t,n)},t}(),F=0;
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.UpgradeComponent=H,t.UpgradeModule=G,t.VERSION=k,t.downgradeComponent=function K(t){var n=function(n,r,o){var i,a=3===w(r),c=a?function(t){return function(){return e.NgZone.isInAngularZone()?t():i.run(t)}}:function(t){return t},s=a&&$(r)>1;return{restrict:"E",terminal:!0,require:["?^^$$angularInjector","?ngModel"],link:function(u,p,h,f){var d=f[1],g=f[0],m=void 0,v=!1;if(!g||s){var $=t.downgradedModule||"",w="$$angularLazyModuleRef"+$,b="instantiating component '"+y(t.component)+"'";j(r,$,w,b);var C=r.get(w);m=C.injector||C.promise}var O=function(r,i){var s=i.get(e.ComponentFactoryResolver).resolveComponentFactory(t.component);if(!s)throw new Error("Expecting ComponentFactory for: "+y(t.component));var l=new S(p),f=new E(p,h,u,d,r,n,o,s,c),g=f.compileContents();f.createComponent(g),f.setupInputs(a,t.propagateDigest),f.setupOutputs(),f.registerCleanup(),l.resolve(f.getInjector()),v&&u.$evalAsync((function(){}))},A=a?function(t,n){i||(i=t.get(e.NgZone)),c((function(){return O(t,n)}))()}:O;D.all([g||m,m||g]).then((function(t){var e=l(t,2);return A(e[0],e[1])})),v=!0}}};return n.$inject=["$compile","$injector","$parse"],n},t.downgradeInjectable=
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function Y(t,e){void 0===e&&(e="");var n=function(n){var r=""+f+e,o="instantiating injectable '"+(b(t)?y(t):String(t))+"'";j(n,e,r,o);try{return n.get(r).get(t)}catch(t){throw new Error("Error while "+o+": "+(t.message||t))}};return n.$inject=["$injector"],n}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,t.downgradeModule=function X(t){var e,r="$$UpgradeModule.lazy"+ ++F,o="$$angularLazyModuleRef"+r,i=""+f+r,a=b(t)?t:function(e){return n.platformBrowser(e).bootstrapModuleFactory(t)};return s(r,[]).constant("$$angularUpgradeAppType",3).factory(f,[i,L]).factory(i,(function(){if(!e)throw new Error("Trying to get the Angular injector before bootstrapping the corresponding Angular module.");return e})).factory("$$angularLazyModuleRef",[o,L]).factory(o,["$injector",function(t){M(t);var n={promise:a(R).then((function(t){return(e=n.injector=new U(t.injector)).get("$injector"),e}))};return n}]).config(["$injector","$provide",function(t,e){e.constant("$$angularDowngradedModuleCount",$(t)+1)}]),r},t.getAngularJSGlobal=c,t.getAngularLib=function Q(){return c()},t.setAngularJSGlobal=a,t.setAngularLib=function tt(t){a(t)},Object.defineProperty(t,"__esModule",{value:!0})}));