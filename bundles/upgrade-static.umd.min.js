...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function Y(t,e){void 0===e&&(e="");var n=function(n){var r=""+f+e,o=w(t)?y(t):String(t);return j(n,e,r,"instantiating injectable '"+o+"'"),n.get(r).get(t)};return n.$inject=["$injector"],n}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,t.downgradeModule=function X(t){var e,r="$$UpgradeModule.lazy"+ ++F,o="$$angularLazyModuleRef"+r,i=""+f+r,a=w(t)?t:function(e){return n.platformBrowser(e).bootstrapModuleFactory(t)};return s(r,[]).constant("$$angularUpgradeAppType",3).factory(f,[i,L]).factory(i,(function(){if(!e)throw new Error("Trying to get the Angular injector before bootstrapping the corresponding Angular module.");return e})).factory("$$angularLazyModuleRef",[o,L]).factory(o,["$injector",function(t){M(t);var n={promise:a(R).then((function(t){return(e=n.injector=new U(t.injector)).get("$injector"),e}))};return n}]).config(["$injector","$provide",function(t,e){e.constant("$$angularDowngradedModuleCount",$(t)+1)}]),r},t.getAngularJSGlobal=c,t.getAngularLib=function Q(){return c()},t.setAngularJSGlobal=a,t.setAngularLib=function tt(t){a(t)},Object.defineProperty(t,"__esModule",{value:!0})}));