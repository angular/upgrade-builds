...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function Y(t,e){void 0===e&&(e="");var n=function(n){var r=""+d+e,o="instantiating injectable '"+(b(t)?y(t):String(t))+"'";j(n,e,r,o);try{return n.get(r).get(t)}catch(t){throw new Error("Error while "+o+": "+(t.message||t))}};return n.$inject=["$injector"],n}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,t.downgradeModule=function X(t){var e,r="$$UpgradeModule.lazy"+ ++L,o="$$angularLazyModuleRef"+r,i=""+d+r,a=b(t)?t:function(e){return n.platformBrowser(e).bootstrapModuleFactory(t)};return s(r,[]).constant("$$angularUpgradeAppType",3).factory(d,[i,x]).factory(i,(function(){if(!e)throw new Error("Trying to get the Angular injector before bootstrapping the corresponding Angular module.");return e})).factory("$$angularLazyModuleRef",[o,x]).factory(o,["$injector",function(t){I(t);var n={promise:a(B).then((function(t){return(e=n.injector=new U(t.injector)).get("$injector"),e}))};return n}]).config(["$injector","$provide",function(t,e){e.constant("$$angularDowngradedModuleCount",$(t)+1)}]),r},t.getAngularJSGlobal=c,t.getAngularLib=function Q(){return c()},t.setAngularJSGlobal=a,t.setAngularLib=function tt(t){a(t)},t.ɵangular_packages_upgrade_static_static_a=M,t.ɵangular_packages_upgrade_static_static_b=P,t.ɵangular_packages_upgrade_static_static_c=R,t.ɵangular_packages_upgrade_static_static_d=N,t.ɵangular_packages_upgrade_static_static_e=B,Object.defineProperty(t,"__esModule",{value:!0})}));