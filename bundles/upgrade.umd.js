...
(function (global, factory) {
    ...
    var DowngradeComponentAdapter = (function () {
        ...
        DowngradeComponentAdapter.prototype.setupInputs = function () {
            ...
            for (var i = 0; i < inputs.length; i++) {
                ...
                if (attrs.hasOwnProperty(input.attr)) {
                    var observeFn = (function (prop /** TODO #9100 */) {
                        var prevValue = INITIAL_VALUE$2;
                        return function (value /** TODO #9100 */) {
                            if (_this.inputChanges !== null) {
                                _this.inputChangeCount++;
                                _this.inputChanges[prop] =
                                    new Ng1Change$1(value, prevValue === INITIAL_VALUE$2 ? value : prevValue);
                                prevValue = value;
                            }
                            _this.component[prop] = value;
                        };
                ...
                if (expr != null) {
                    var watchFn = (function (prop /** TODO #9100 */) {
                        return function (value /** TODO #9100 */, prevValue /** TODO #9100 */) {
                            if (_this.inputChanges != null) {
                                _this.inputChangeCount++;
                                _this.inputChanges[prop] = new Ng1Change$1(prevValue, value);
                            }
                            _this.component[prop] = value;
                        };
                    })(input.prop);
    ...
    var NOT_SUPPORTED$1 = 'NOT_SUPPORTED';
    var INITIAL_VALUE$3 = {
        __UNINITIALIZED__: true
    };
    ...
    var UpgradeComponent = (function () {
        ...
        UpgradeComponent.prototype.ngOnInit = function () {
            ...
            var attrs = NOT_SUPPORTED$1;
            var transcludeFn = NOT_SUPPORTED$1;
            var linkController = this.resolveRequired(this.$element, this.directive.require);
            var link = this.directive.link;
                ...
                Object.keys(context).forEach(function (propName) {
                    ...
                    switch (bindingType) {
                        ...
                        case '=':
                            ...
                            bindings.twoWayBoundLastValues.push(INITIAL_VALUE$3);
