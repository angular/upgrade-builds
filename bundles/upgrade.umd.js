(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define('@angular/upgrade', ['exports', '@angular/core', '@angular/compiler', '@angular/platform-browser-dynamic'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('@angular/core'), require('@angular/compiler'), require('@angular/platform-browser-dynamic'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.ng.core, global.ng.compiler, global.ng.platformBrowserDynamic);
        global.ng = global.ng || {};
        global.ng.upgrade = mod.exports;
    }
})(this, function (exports, _core, _compiler, _platformBrowserDynamic) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.UpgradeAdapterRef = exports.UpgradeAdapter = exports.VERSION = undefined;
    ...
    var DowngradeComponentAdapter = function () {
        ...
        _createClass(DowngradeComponentAdapter, [{
            ...
            value: function createComponent(projectableNodes) {
                var /** @type {?} */childInjector = _core.ReflectiveInjector.resolveAndCreate([{ provide: $SCOPE, useValue: this.componentScope }], this.parentInjector);
            ...
            return {
                ...
                link: function link(scope, element, attrs, required) {
                    ...
                    var /** @type {?} */downgradeFn = function downgradeFn(injector) {
                        var /** @type {?} */componentFactoryResolver = injector.get(_core.ComponentFactoryResolver);
            ...
            value: function groupNodesBySelector(ngContentSelectors, nodes) {
                ...
                for (var /** @type {?} */i = 0, /** @type {?} */ii = ngContentSelectors.length; i < ii; ++i) {
                    ...
                    if (selector === '*') {
                        ...
                        matcher.addSelectables(_compiler.CssSelector.parse(selector), i);
                    }
                }
                ...
                var _loop = function _loop(j, jj) {
                    ...
                    var /** @type {?} */selector = (0, _compiler.createElementCssSelector)(node.nodeName.toLowerCase(), getAttributesAsArray(node));
    ...
    var UpgradeNg1ComponentAdapterBuilder = function () {
        ...
        function UpgradeNg1ComponentAdapterBuilder(name) {
            ...
            var self = this;
            this.type = (0, _core.Directive)({ selector: selector, inputs: this.inputsRename, outputs: this.outputsRename }).Class({
                constructor: [new _core.Inject($SCOPE), _core.ElementRef, function (scope, elementRef) {
    ...
    var UpgradeNg1ComponentAdapter = function () {
        ...
        function UpgradeNg1ComponentAdapter(linkFn, scope, directive, elementRef, $controller, inputs, outputs, propOuts, checkProperties, propertyMap) {
            ...
            for (var j = 0; j < outputs.length; j++) {
                var emitter = this /** TODO #9100 */[outputs[j]] = new _core.EventEmitter();
            ...
            for (var k = 0; k < propOuts.length; k++) {
                this /** TODO #9100 */[propOuts[k]] = new _core.EventEmitter();
    ...
    var UpgradeAdapter = function () {
        ...
        function UpgradeAdapter(ng2AppModule, compilerOptions) {
            ...
            this.directiveResolver = new _compiler.DirectiveResolver();
        ...
        _createClass(UpgradeAdapter, [{
            ...
            value: function bootstrap(element$$, modules, config) {
                ...
                Promise.all([this.ng2BootstrapDeferred.promise, ng1BootstrapPromise]).then(function (_ref) {
                    ...
                    _this11.moduleRef.injector.get(_core.NgZone).run(function () {
            ...
            value: function declareNg1Module() {
                ...
                var /** @type {?} */platformRef = (0, _platformBrowserDynamic.platformBrowserDynamic)();
                this.ngZone = new _core.NgZone({ enableLongStackTrace: Zone.hasOwnProperty('longStackTraceZoneSpec') });
                this.ng2BootstrapDeferred = new Deferred();
                ng1Module.factory(INJECTOR_KEY, function () {
                    return _this12.moduleRef.injector.get(_core.Injector);
                }).constant(NG_ZONE_KEY, this.ngZone).factory(COMPILER_KEY, function () {
                    return _this12.moduleRef.injector.get(_core.Compiler);
                        ...
                        provide.decorator($$TESTABILITY, ['$delegate', function (testabilityDelegate) {
                            ...
                            var /** @type {?} */newWhenStable = function newWhenStable(callback) {
                                originalWhenStable.call(this, function () {
                                    var /** @type {?} */ng2Testability = upgradeAdapter.moduleRef.injector.get(_core.Testability);
                ...
                ng1Module.run(['$injector', '$rootScope', function (ng1Injector, rootScope) {
                    UpgradeNg1ComponentAdapterBuilder.resolve(_this12.ng1ComponentsToBeUpgraded, ng1Injector).then(function () {
                        ...
                        var /** @type {?} */DynamicNgUpgradeModule = (0, _core.NgModule)({
